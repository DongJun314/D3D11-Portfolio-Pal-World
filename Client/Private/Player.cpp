...
void Client::CPlayer::InitMeshComponent()
{
	...
	// 화살
	{
		...
		tArrowDesc.m_matPivot = Matrix::CreateScale(0.002f);// *Matrix::CreateRotationX(XMConvertToRadians(-90.f));
...
void Client::CPlayer::InitProjectilePool()
{
	...
	// 화살 풀
	{
		...
		tArrowPool.m_matPivot			= Matrix::CreateScale(0.0005f);
...
void Client::CPlayer::ComputeHunger(float _fDeltaSeconds)
{
	...
	{
		m_fCurHungerGauge -= _fDeltaSeconds * 0.1f;
