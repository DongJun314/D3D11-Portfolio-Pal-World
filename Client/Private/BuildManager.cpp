...
#pragma endregion
	...
	#pragma region 일반 건축물
	{
		...
		case EArchitectureType::WORKBENCH:
		{
			...
			tWorkBenchDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 5.f;
...
#pragma endregion
		...
		case EArchitectureType::IRON_BOX:
		{
			...
			tChestDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 20.f;
...
#pragma endregion
		...
		case EArchitectureType::BERRY_FARM:
		{
			...
			tBerryFarmDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 30.f;
		...
		case EArchitectureType::BLAST_FURNACE:
		{
			...
			tBlastFurnaceDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 30.f;
		...
		case EArchitectureType::POT:
		{
			...
			tKitchenMedievalDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 30.f;
		...
		case EArchitectureType::WEAPON_WORKBENCH:
		{
			...
			tWeaponWorkBenchDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 50.f;
		...
		case EArchitectureType::QUARRY:
		{
			...
			tStonePitDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 50.f;
		...
		case EArchitectureType::LUMBERYARD:
		{
			...
			tLumberYardDesc.m_tBuildStatus.m_fMaxDeltaSeconds = 50.f;
