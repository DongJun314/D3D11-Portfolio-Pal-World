...
namespace Client
{
	...
	/********************
		Description
	********************/
	struct FTaskBerryGoatAttackLoopDesc : public FBTNodeDesc
	{
	...
	class CTaskBerryGoatAttackLoop final : public CTaskNode
	{
	/********************
		Ctor/Dtor
	********************/
	public:
		explicit CTaskBerryGoatAttackLoop() = default;

		virtual ~CTaskBerryGoatAttackLoop() = default;

	/********************
		Events
	********************/
	public:
		static std::shared_ptr<CTaskBerryGoatAttackLoop> Create(const std::shared_ptr<FTaskBerryGoatAttackLoopDesc>& _spTaskBerryGoatAttackLoopDesc);
