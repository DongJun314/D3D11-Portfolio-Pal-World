...
namespace Client
{
	/********************
		Descriptor
	********************/
	struct FPenguinDesc : public FMonsterDesc
	{
	};
	...
	********************/
	public:
		static std::shared_ptr<CPenguin> Create(const std::shared_ptr<FPenguinDesc>& _spPenguinDesc);
	...
	********************/
	public:
		void InitPenguin(const std::shared_ptr<FPenguinDesc>& _spPenguinDesc);

		void InitMeshComponent();

		void InitColliderComponent();

		void InitBehaviorTreeComponent(const std::shared_ptr<FPenguinDesc>& _spPenguinDesc);

	private:
		void InitializeWildPalBT(const std::shared_ptr<FPenguinDesc> _spPenguinDesc, bool _bInit = true);

		void InitializePartnerPalBT(const std::shared_ptr<FPenguinDesc> _spPenguinDesc, bool _bInit = true);

		void InitializeSlavePalBT(const std::shared_ptr<FPenguinDesc> _spPenguinDesc, bool _bInit = true);
