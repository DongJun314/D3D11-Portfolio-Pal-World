...
namespace Client
{
	...
	/********************
		Description
	********************/
	struct FTaskDreamDemonAttackLoopDesc : public FBTNodeDesc
	{
	...
	class CTaskDreamDemonAttackLoop final : public CTaskNode
	{
	/********************
		Ctor/Dtor
	********************/
	public:
		explicit CTaskDreamDemonAttackLoop() = default;

		virtual ~CTaskDreamDemonAttackLoop() = default;

	/********************
		Events
	********************/
	public:
		static std::shared_ptr<CTaskDreamDemonAttackLoop> Create(const std::shared_ptr<FTaskDreamDemonAttackLoopDesc>& _spTaskAttackLoopDesc);
