...
namespace Client
{
	...
	public:
		...
		{
			{ EIngredientType::EGG,					2 },
			{ EIngredientType::SHEEPBALL_MEAT,		5 },
			{ EIngredientType::BOAR_MEAT,		5 },
			{ EIngredientType::RED_BERRY,			1 },
			{ EIngredientType::BAKED_BERRY,			1 },
			{ EIngredientType::FRIED_EGG,			1 },
			{ EIngredientType::SHEEPBALL_KEBAB,		1 },
			{ EIngredientType::CHICKEN_KEBAB,		1 },
			{ EIngredientType::SHEEPBALL_ROAST,		1 },
			{ EIngredientType::CHICKEN_ROAST,		1 },
		};
